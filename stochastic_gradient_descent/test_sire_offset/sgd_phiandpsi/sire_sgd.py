...
def exclusion_offset(quantum,amber):
...
#        else:#
        ...
        #diff = (eqm - (emm + offset + k1phi*math.cos(phi_angle) - k1phi*phi_1cos +k2phi*math.cos(2*phi_angle) - k2phi*phi_2cos +k3phi*math.cos(3*phi_angle) -k3phi*phi_3cos +\
        #        k1psi*math.cos(psi_angle) - k1psi*psi_1cos + k2psi*math.cos(2*psi_angle) - k2psi*psi_2cos + k3psi*math.cos(3*psi_angle) - k3psi*psi_3cos))**2
...
print(offset)
#offset = exclusion_offset(rel_orig,rel_zero)
#print(offset)
    ...
    if  iteration < epoch_limit:
        ...
        if iteration > mom_limit :
            ...
            dk1_phi_new = 0.9*dk1_phi + alpha*((eqm - emm - offset - k1phi*math.cos(phi_angle) + k1phi*phi_1cos - k2phi*math.cos(2*phi_angle) +k2phi*phi_2cos - k3phi*math.cos(3*phi_angle) + k3phi*phi_3cos -\
                                        k1psi*math.cos(psi_angle-math.pi) + k1psi*psi_1cos - k2psi*math.cos(2*psi_angle-math.pi) + k2psi*psi_2cos- k3psi*math.cos(3*psi_angle-math.pi ) + k3psi*psi_3cos )  *\
                                        (-math.cos(phi_angle) + phi_1cos))
            ...
            dk1_psi_new = 0.9*dk1_psi + alpha*((eqm - emm - offset - k1phi*math.cos(phi_angle) + k1phi*phi_1cos - k2phi*math.cos(2*phi_angle) +k2phi*phi_2cos - k3phi*math.cos(3*phi_angle) + k3phi*phi_3cos -\
                                        k1psi*math.cos(psi_angle-math.pi)+k1psi*psi_1cos - k2psi*math.cos(2*psi_angle-math.pi ) + k2psi*psi_2cos- k3psi*math.cos(3*psi_angle-math.pi)+ k3psi*psi_3cos )  *\
                                        (-math.cos(psi_angle-math.pi) + psi_1cos))
            dk2_psi_new =0.9*dk2_psi + alpha*((eqm - emm - offset - k1phi*math.cos(phi_angle) + k1phi*phi_1cos - k2phi*math.cos(2*phi_angle) + k2phi*phi_2cos - k3phi*math.cos(3*phi_angle) +k3phi*phi_3cos -\
                                        k1psi*math.cos(psi_angle-math.pi) +k1psi*psi_1cos - k2psi*math.cos(2*psi_angle-math.pi) +k2psi*psi_2cos- k3psi*math.cos(3*psi_angle-math.pi ) +k3psi*psi_3cos )  *\
                                        (-math.cos(2*psi_angle-math.pi) + psi_2cos))
            dk3_psi_new =0.9*dk3_psi + alpha*((eqm - emm - offset - k1phi*math.cos(phi_angle) +k1phi*phi_1cos - k2phi*math.cos(2*phi_angle) +k2phi*phi_2cos - k3phi*math.cos(3*phi_angle) + k3phi*phi_3cos -\
                                        k1psi*math.cos(psi_angle-math.pi) +k1psi*psi_1cos - k2psi*math.cos(2*psi_angle-math.pi) + k2psi*psi_2cos- k3psi*math.cos(3*psi_angle-math.pi ) + k3psi*psi_3cos )  *\
                                        (-math.cos(3*psi_angle-math.pi) + psi_3cos))
            ...
            dk1_phi_new = 0.2*dk1_phi + alpha*((eqm - emm - offset - k1phi*math.cos(phi_angle) + k1phi*phi_1cos - k2phi*math.cos(2*phi_angle) +k2phi*phi_2cos - k3phi*math.cos(3*phi_angle) + k3phi*phi_3cos -\
                                        k1psi*math.cos(psi_angle-math.pi) + k1psi*psi_1cos - k2psi*math.cos(2*psi_angle-math.pi) + k2psi*psi_2cos- k3psi*math.cos(3*psi_angle-math.pi ) + k3psi*psi_3cos )  *\
                                        (-math.cos(phi_angle) + phi_1cos))
            dk2_phi_new = 0.2*dk2_phi + alpha*((eqm - emm - offset - k1phi*math.cos(phi_angle) + k1phi*phi_1cos - k2phi*math.cos(2*phi_angle) + k2phi*phi_2cos - k3phi*math.cos(3*phi_angle) + k3phi*phi_3cos -\
                                        k1psi*math.cos(psi_angle-math.pi) + k1psi*psi_1cos - k2psi*math.cos(2*psi_angle-math.pi ) + k2psi*psi_2cos- k3psi*math.cos(3*psi_angle-math.pi ) + k3psi*psi_3cos )  *\
                                        (-math.cos(2*phi_angle) + phi_2cos))
            dk3_phi_new = 0.2*dk3_phi + alpha*((eqm - emm - offset - k1phi*math.cos(phi_angle) + k1phi*phi_1cos - k2phi*math.cos(2*phi_angle)+k2phi*phi_2cos - k3phi*math.cos(3*phi_angle) + k3phi*phi_3cos -\
                                        k1psi*math.cos(psi_angle-math.pi) + k1psi*psi_1cos - k2psi*math.cos(2*psi_angle-math.pi ) + k2psi*psi_2cos- k3psi*math.cos(3*psi_angle-math.pi ) + k3psi*psi_3cos )  *\
                                        (-math.cos(3*phi_angle) + phi_3cos))

            dk1_psi_new = 0.2*dk1_psi + alpha*((eqm - emm - offset - k1phi*math.cos(phi_angle) + k1phi*phi_1cos - k2phi*math.cos(2*phi_angle) +k2phi*phi_2cos - k3phi*math.cos(3*phi_angle) + k3phi*phi_3cos -\
                                        k1psi*math.cos(psi_angle-math.pi)+k1psi*psi_1cos - k2psi*math.cos(2*psi_angle-math.pi ) + k2psi*psi_2cos- k3psi*math.cos(3*psi_angle-math.pi)+ k3psi*psi_3cos )  *\
                                        (-math.cos(psi_angle-math.pi) + psi_1cos))
            dk2_psi_new =0.2*dk2_psi + alpha*((eqm - emm - offset - k1phi*math.cos(phi_angle) + k1phi*phi_1cos - k2phi*math.cos(2*phi_angle) + k2phi*phi_2cos - k3phi*math.cos(3*phi_angle) +k3phi*phi_3cos -\
                                        k1psi*math.cos(psi_angle-math.pi) +k1psi*psi_1cos - k2psi*math.cos(2*psi_angle-math.pi) +k2psi*psi_2cos- k3psi*math.cos(3*psi_angle-math.pi ) +k3psi*psi_3cos )  *\
                                        (-math.cos(2*psi_angle-math.pi) + psi_2cos))
            dk3_psi_new =0.2*dk3_psi + alpha*((eqm - emm - offset - k1phi*math.cos(phi_angle) +k1phi*phi_1cos - k2phi*math.cos(2*phi_angle) +k2phi*phi_2cos - k3phi*math.cos(3*phi_angle) + k3phi*phi_3cos -\
                                        k1psi*math.cos(psi_angle-math.pi) +k1psi*psi_1cos - k2psi*math.cos(2*psi_angle-math.pi) + k2psi*psi_2cos- k3psi*math.cos(3*psi_angle-math.pi ) + k3psi*psi_3cos )  *\
                                        (-math.cos(3*psi_angle-math.pi) + psi_3cos))
