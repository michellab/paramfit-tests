...
def eval_function(dict_structures,offset,k1psi,k2psi,k3psi):
# eval : energies sum_i^m(EQM - EMM - ct - all the dihedrals to fit)^2
    ...
    for key in dict_structures:
        ...
        sum_squared += (eqm - emm - offset - k1psi*math.cos(psi_angle) - k1psi*psi_1cos - k2psi*math.cos(2*psi_angle) - k2psi*psi_2cos - k3psi*math.cos(3*psi_angle) - k3psi*psi_3cos)**2
        counter +=1

        emm_offset = emm + offset
        emm_trunc_minus =emm_offset + ( k1psi*math.cos(psi_angle)  - k1psi*psi_1cos  + k2psi*math.cos((2*psi_angle))  -\
                                        k2psi*psi_2cos  + k3psi*math.cos((3*psi_angle) ) - k3psi*psi_3cos)
...
alpha = 0.001 # training parameter
convergence = True
epoch_limit =  100000
mom_limit = 200000
iteration = 0
...
while(convergence):
    ...
    if  iteration < epoch_limit:
        ...
        k1psi_new = k1psi - alpha*((eqm - emm - offset - k1psi*math.cos(psi_angle) -k1psi*psi_1cos - k2psi*math.cos(2*psi_angle ) - k2psi*psi_2cos- k3psi*math.cos(3*psi_angle)- k3psi*psi_3cos )  *\
                                    (-math.cos(psi_angle) - psi_1cos))
        k2psi_new = k2psi - alpha*((eqm - emm - offset - k1psi*math.cos(psi_angle) -k1psi*psi_1cos - k2psi*math.cos(2*psi_angle) - k2psi*psi_2cos- k3psi*math.cos(3*psi_angle ) - k3psi*psi_3cos )  *\
                                    (-math.cos(2*psi_angle) - psi_2cos))
        k3psi_new = k3psi - alpha*((eqm - emm - offset - k1psi*math.cos(psi_angle) -k1psi*psi_1cos - k2psi*math.cos(2*psi_angle) - k2psi*psi_2cos- k3psi*math.cos(3*psi_angle ) - k3psi*psi_3cos )  *\
                                    (-math.cos(3*psi_angle) - psi_3cos))

        s_val = eval_function(dict_structures,offset,k1psi_new,k2psi_new,k3psi_new)
        ...
        print(k1psi_new,k2psi_new,k3psi_new)
