...
# eval : energies sum_i^m(EQM - EMM - ct - all the dihedrals to fit)^2
    ...
    phi_1cos = phi_1cos/len(dict_structures)
    phi_2cos = phi_2cos/len(dict_structures)
    phi_3cos = phi_3cos/len(dict_structures)
    psi_1cos = psi_1cos/len(dict_structures)
    psi_2cos = psi_2cos/len(dict_structures)
    psi_3cos = psi_3cos/len(dict_structures)
    ...
    for key in dict_structures:
        ...
        sum_squared += (eqm - emm - offset - k1phi*math.cos(phi_angle) - k1phi*phi_1cos - k2phi*math.cos(2*phi_angle) - k2phi*phi_2cos - k3phi*math.cos(3*phi_angle) - k3phi*phi_3cos -\
                            k1psi*math.cos(psi_angle - math.pi) - k1psi*psi_1cos - k2psi*math.cos(2*psi_angle - math.pi) - k2psi*psi_2cos - k3psi*math.cos(3*psi_angle - math.pi) - k3psi*psi_3cos)**2
