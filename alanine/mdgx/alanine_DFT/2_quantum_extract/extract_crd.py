...
def rst7writer(coords,natoms,output_folder,file_name,phi_val,top_file,mp2,trajfile):
...
dir_base = sys.argv[9]
traj_name = dir_base  + "/gen_mdcrd.traj"
cpptraj_file = open(traj_name,"a")
...
rst7_file = rst7writer(coords,natoms,output_folder,file_out,phi_val,top_file,mp2,cpptraj_file)
