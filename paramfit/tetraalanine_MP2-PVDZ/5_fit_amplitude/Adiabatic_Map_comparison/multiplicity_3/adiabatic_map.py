...
def collect_quantum_energies(quantum_outputs):
    ...
    for f in input_files:
        ...
        dict_energy[phi,psi] = float(en_val)*627.50
...
def differences(quantum,amber):
    diff = {}
    for key in quantum :
        qua_en = float(quantum[key])
        amb_en = float(amber[key])
        val_phi = key[0]
        val_psi = key[1]
        diff_en = qua_en - amb_en
        diff[val_phi,val_psi] = diff_en
...
#Input varialbes
quantum_outputs = "../../../3_mp2_calculation/mp2_output/*/structure*.out" #../2_quantum_extract/quantum_outputs/*/structure*.out
amber_coords = "../../../3_mp2_calculation/extract_crd/crd_outputs/*/structure*.crd"
amber_top = "fit.prmtop"
ff99SB_top = "mol.prmtop"
#Calling dictionary
...
print("Calculating ff99SB dictionary...")
dict_ff99SB =  collect_amber_energies(ff99SB_top,amber_coords)
print("Calculating difference dictionary...")
dict_diff = differences(dict_quantum,dict_amber)  #this is between new amber and amberff99SB
print("Calculating difference dictionary for ff99SB")
dict_diff_ff99 = differences(dict_quantum,dict_ff99SB)
#Create the plots
print(dict_quantum)
...
print("Creating ff99SB plots")
adiabatic(dict_ff99SB,"Adiabatic_ff99SB.png")
print("Creating difference plots")
adiabatic(dict_diff,"Differences_QMvsNew.png")
print("Creating difference plots for ff99SB")
adiabatic(dict_diff_ff99,"Differences_QMvsff99SB.png")
